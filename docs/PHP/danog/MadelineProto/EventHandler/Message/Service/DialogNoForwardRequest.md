---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogNoForwardRequest: Emitted only in private chats if the other side requested to disable content protection »."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogNoForwardRequest`
...
## Properties
* `$expired`: `bool` If set, this request was accepted or rejected by the other user and thus cannot be used anymore.
* `$prev`: `bool` Previous protection status.
* `$new`: `bool` New requested protection status.
* `$id`: `int` Message ID
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, bool $expired, bool $prev, bool $new)`](#__construct)
...
## Methods:
### <a name="__construct"></a> `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, bool $expired, bool $prev, bool $new)`
