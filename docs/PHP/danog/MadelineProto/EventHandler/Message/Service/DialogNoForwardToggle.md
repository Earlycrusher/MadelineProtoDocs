---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogNoForwardToggle: Emitted only in private chats when enabling or disabling content protection »."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogNoForwardToggle`
...
## Properties
* `$prev`: `bool` Previous protection status (if true, the chat was protected). May be equal to new_value when replying to requests
* `$new`: `bool` New protection status.
* `$id`: `int` Message ID
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, bool $prev, bool $new)`](#__construct)
...
## Methods:
### <a name="__construct"></a> `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, bool $prev, bool $new)`
