...
* [\danog\MadelineProto\EventHandler\Message\Entities\TextWithEntities](/PHP/danog/MadelineProto/EventHandler/Message/Entities/TextWithEntities.html)
...
* [\danog\MadelineProto\EventHandler\Message\Service\DialogGiftStars: Info about a gifted Telegram Stars.](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogGiftStars.html)
...
* [\danog\MadelineProto\EventHandler\Message\Service\DialogNoForwardRequest: Emitted only in private chats if the other side requested to disable content protection ».](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogNoForwardRequest.html)
* [\danog\MadelineProto\EventHandler\Message\Service\DialogNoForwardToggle: Emitted only in private chats when enabling or disabling content protection ».](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogNoForwardToggle.html)
* [\danog\MadelineProto\EventHandler\Message\Service\DialogPaymentSent: A payment was sent.](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogPaymentSent.html)
* [\danog\MadelineProto\EventHandler\Message\Service\DialogPaymentSentMe: A user just sent a payment to me (a bot).](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogPaymentSentMe.html)
...
* [\danog\MadelineProto\EventHandler\Message\Service\DialogStarGift: Info about a Star gifted.](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogStarGift.html)
...
* [\danog\MadelineProto\EventHandler\Payments\Payment: This object contains information about an incoming pre-checkout query.](/PHP/danog/MadelineProto/EventHandler/Payments/Payment.html)
* [\danog\MadelineProto\EventHandler\Payments\PaymentCharge: Payment identifier.](/PHP/danog/MadelineProto/EventHandler/Payments/PaymentCharge.html)
* [\danog\MadelineProto\EventHandler\Payments\PaymentRequestedInfo](/PHP/danog/MadelineProto/EventHandler/Payments/PaymentRequestedInfo.html)
* [\danog\MadelineProto\EventHandler\Payments\StarGift](/PHP/danog/MadelineProto/EventHandler/Payments/StarGift.html)
...
* [\danog\MadelineProto\RPCError\BusinessConnectionNotAllowedError: This method was invoked over a business connection using [invokeWithBusinessConnection](https://core.telegram.org/api/business#connected-bots), but either (1) we're a user, and users cannot invoke methods over a business connection; (2) we're a bot, but business mode was disabled in @botfather or (3); we're a bot, but this method cannot be invoked over a business connection.](/PHP/danog/MadelineProto/RPCError/BusinessConnectionNotAllowedError.html)
* [\danog\MadelineProto\RPCError\BusinessPeerUsageMissingError: You cannot send a message to a user through a [business connection](https://core.telegram.org/api/business#connected-bots) if the user hasn't recently contacted us.](/PHP/danog/MadelineProto/RPCError/BusinessPeerUsageMissingError.html)
...
* [\danog\MadelineProto\RPCError\ChannelMonoforumUnsupportedError: [Monoforums](https://core.telegram.org/api/channel#monoforums) do not support this feature.](/PHP/danog/MadelineProto/RPCError/ChannelMonoforumUnsupportedError.html)
...
* [\danog\MadelineProto\RPCError\FileReferenceExpiredError: File reference expired, it must be refetched as described in [the documentation](https://core.telegram.org/api/file-references).](/PHP/danog/MadelineProto/RPCError/FileReferenceExpiredError.html)
...
* [\danog\MadelineProto\RPCError\QuickRepliesBotNotAllowedError: [Quick replies](https://core.telegram.org/api/business#quick-reply-shortcuts) cannot be used by bots.](/PHP/danog/MadelineProto/RPCError/QuickRepliesBotNotAllowedError.html)
