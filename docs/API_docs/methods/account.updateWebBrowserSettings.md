...
description: "account.updateWebBrowserSettings parameters, return type and example"
grand_parent: "Telegram RPC API"
parent: "Methods"
image: https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png
redirect_from: /API_docs/methods/account_updateWebBrowserSettings.html
---
...
$account_WebBrowserSettings = $MadelineProto->account->updateWebBrowserSettings(open_external_browser: $Bool, display_close_button: $Bool, );
```
