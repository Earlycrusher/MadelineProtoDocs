...
description: "messages.getUnreadPollVotes parameters, return type and example"
grand_parent: "Telegram RPC API"
parent: "Methods"
image: https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png
redirect_from: /API_docs/methods/messages_getUnreadPollVotes.html
---
...
$messages_Messages = $MadelineProto->messages->getUnreadPollVotes(peer: $InputPeer, top_msg_id: $int, offset_id: $int, add_offset: $int, limit: $int, max_id: $int, min_id: $int, );
```
