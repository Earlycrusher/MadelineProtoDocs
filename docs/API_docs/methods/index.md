...
* <a href="payments.updateStarGiftPrice.html" name="payments.updateStarGiftPrice">A collectible gift we own » can be put up for sale on the gift marketplace » with this method, see here » for more info: payments.updateStarGiftPrice</a>
...
* <a href="payments.updateStarGiftCollection.html" name="payments.updateStarGiftCollection">Add or remove gifts from a star gift collection », or rename the collection: payments.updateStarGiftCollection</a>
...
* <a href="account.saveMusic.html" name="account.saveMusic">Adds or removes a song from the current user's profile see here » for more info on the music tab of the profile page: account.saveMusic</a>
...
* <a href="account.toggleNoPaidMessagesException.html" name="account.toggleNoPaidMessagesException">Allow a user to send us messages without paying if paid messages » are enabled: account.toggleNoPaidMessagesException</a>
...
* <a href="messages.appendTodoList.html" name="messages.appendTodoList">Appends one or more items to a todo list »: messages.appendTodoList</a>
...
* <a href="messages.toggleSuggestedPostApproval.html" name="messages.toggleSuggestedPostApproval">Approve or reject a suggested post »: messages.toggleSuggestedPostApproval</a>
...
* <a href="phone.sendConferenceCallBroadcast.html" name="phone.sendConferenceCallBroadcast">Broadcast a blockchain block to all members of a conference call, see here » for more info: phone.sendConferenceCallBroadcast</a>
...
* <a href="channels.getMessageAuthor.html" name="channels.getMessageAuthor">Can only be invoked by non-bot admins of a monoforum », obtains the original sender of a message sent by other monoforum admins to the monoforum, on behalf of the channel associated to the monoforum: channels.getMessageAuthor</a>
...
* <a href="messages.setChatTheme.html" name="messages.setChatTheme">Change the chat theme of a certain chat, see here » for more info: messages.setChatTheme</a>
...
* <a href="channels.setMainProfileTab.html" name="channels.setMainProfileTab">Changes the main profile tab of a channel, see here » for more info: channels.setMainProfileTab</a>

* <a href="account.setMainProfileTab.html" name="account.setMainProfileTab">Changes the main profile tab of the current user, see here » for more info: account.setMainProfileTab</a>
...
* <a href="users.getSavedMusicByID.html" name="users.getSavedMusicByID">Check if the passed songs are still pinned to the user's profile, or refresh the file references of songs pinned on a user's profile see here » for more info: users.getSavedMusicByID</a>

* <a href="payments.checkCanSendGift.html" name="payments.checkCanSendGift">Check if the specified gift » can be sent: payments.checkCanSendGift</a>

* <a href="channels.checkSearchPostsFlood.html" name="channels.checkSearchPostsFlood">Check if the specified global post search » requires payment: channels.checkSearchPostsFlood</a>
...
* <a href="users.getRequirementsToContact.html" name="users.getRequirementsToContact">Check whether we can write to the specified users, used to implement bulk checks for Premium-only messages » and paid messages »: users.getRequirementsToContact</a>

* <a href="payments.canPurchaseStore.html" name="payments.canPurchaseStore">Checks whether a purchase is possible. Must be called before in-store purchase, official apps only: payments.canPurchaseStore</a>
...
* <a href="payments.getStarGiftWithdrawalUrl.html" name="payments.getStarGiftWithdrawalUrl">Convert a collectible gift » to an NFT on the TON blockchain: payments.getStarGiftWithdrawalUrl</a>
...
* <a href="payments.createStarGiftCollection.html" name="payments.createStarGiftCollection">Create a star gift collection »: payments.createStarGiftCollection</a>
...
* <a href="stories.createAlbum.html" name="stories.createAlbum">Creates a story album: stories.createAlbum</a>
...
* <a href="payments.deleteStarGiftCollection.html" name="payments.deleteStarGiftCollection">Delete a star gift collection »: payments.deleteStarGiftCollection</a>

* <a href="stories.deleteAlbum.html" name="stories.deleteAlbum">Delete a story album: stories.deleteAlbum</a>
...
* <a href="messages.deleteSavedHistory.html" name="messages.deleteSavedHistory">Deletes messages from a monoforum topic », or deletes messages forwarded from a specific peer to saved messages »: messages.deleteSavedHistory</a>
...
* <a href="smsjobs.leave.html" name="smsjobs.leave">Disable SMS jobs (official clients only): smsjobs.leave</a>
...
* <a href="account.editBusinessChatLink.html" name="account.editBusinessChatLink">Edit a created business chat deep link »: account.editBusinessChatLink</a>
...
* <a href="channels.updatePaidMessagesPrice.html" name="channels.updatePaidMessagesPrice">Enable or disable paid messages » in this supergroup or monoforum: channels.updatePaidMessagesPrice</a>
...
* <a href="payments.getStarsTransactions.html" name="payments.getStarsTransactions">Fetch Telegram Stars transactions: payments.getStarsTransactions</a>
...
* <a href="payments.getSavedStarGift.html" name="payments.getSavedStarGift">Fetch info about specific gifts owned by a peer we control: payments.getSavedStarGift</a>
...
* <a href="messages.getSavedHistory.html" name="messages.getSavedHistory">Fetch saved messages » forwarded from a specific peer, or fetch messages from a monoforum topic »: messages.getSavedHistory</a>
...
* <a href="phone.getGroupCallChainBlocks.html" name="phone.getGroupCallChainBlocks">Fetch the blocks of a conference blockchain »: phone.getGroupCallChainBlocks</a>
...
* <a href="payments.getSavedStarGifts.html" name="payments.getSavedStarGifts">Fetch the full list of gifts owned by a peer: payments.getSavedStarGifts</a>

* <a href="account.getSavedMusicIds.html" name="account.getSavedMusicIds">Fetch the full list of only the IDs of songs currently added to the profile, see here » for more info: account.getSavedMusicIds</a>
...
* <a href="messages.getAvailableEffects.html" name="messages.getAvailableEffects">Fetch the full list of usable animated message effects »: messages.getAvailableEffects</a>
...
* <a href="payments.getStarGiftCollections.html" name="payments.getStarGiftCollections">Fetches all star gift collections » of a peer: payments.getStarGiftCollections</a>
...
* <a href="payments.getResaleStarGifts.html" name="payments.getResaleStarGifts">Get collectible gifts of a specific type currently on resale, see here » for more info: payments.getResaleStarGifts</a>
...
* <a href="payments.getUniqueStarGiftValueInfo.html" name="payments.getUniqueStarGiftValueInfo">Get information about the value of a collectible gift »: payments.getUniqueStarGiftValueInfo</a>
...
* <a href="users.getSavedMusic.html" name="users.getSavedMusic">Get songs pinned to the user's profile, see here » for more info: users.getSavedMusic</a>
...
* <a href="stories.getAlbumStories.html" name="stories.getAlbumStories">Get stories in a story album »: stories.getAlbumStories</a>

* <a href="stories.getAlbums.html" name="stories.getAlbums">Get story albums created by a peer: stories.getAlbums</a>
...
* <a href="channels.searchPosts.html" name="channels.searchPosts">Globally search for posts from public channels » (including those we aren't a member of) containing either a specific hashtag, or a full text query: channels.searchPosts</a>
...
* <a href="phone.inviteConferenceCallParticipant.html" name="phone.inviteConferenceCallParticipant">Invite a user to a conference call: phone.inviteConferenceCallParticipant</a>
...
* <a href="channels.readMessageContents.html" name="channels.readMessageContents">Mark channel/supergroup message contents as read, emitting an updateChannelReadMessagesContents: channels.readMessageContents</a>
...
* <a href="messages.readSavedHistory.html" name="messages.readSavedHistory">Mark messages as read in a monoforum topic »: messages.readSavedHistory</a>
...
* <a href="messages.toggleTodoCompleted.html" name="messages.toggleTodoCompleted">Mark one or more items of a todo list » as completed or not completed: messages.toggleTodoCompleted</a>
...
* <a href="payments.getStarsGiftOptions.html" name="payments.getStarsGiftOptions">Obtain a list of Telegram Stars gift options » as starsGiftOption constructors: payments.getStarsGiftOptions</a>
...
* <a href="account.getCollectibleEmojiStatuses.html" name="account.getCollectibleEmojiStatuses">Obtain a list of emoji statuses » for owned collectible gifts: account.getCollectibleEmojiStatuses</a>
...
* <a href="bots.getBotRecommendations.html" name="bots.getBotRecommendations">Obtain a list of similarly themed bots, selected based on similarities in their subscriber bases, see here » for more info: bots.getBotRecommendations</a>
...
* <a href="contacts.getSponsoredPeers.html" name="contacts.getSponsoredPeers">Obtain a list of sponsored peer search results for a given query: contacts.getSponsoredPeers</a>
...
* <a href="payments.getStarGiftUpgradePreview.html" name="payments.getStarGiftUpgradePreview">Obtain a preview of the possible attributes (chosen randomly) a gift » can receive after upgrading it to a collectible gift », see here » for more info: payments.getStarGiftUpgradePreview</a>

* <a href="account.getUniqueGiftChatThemes.html" name="account.getUniqueGiftChatThemes">Obtain all chat themes » associated to owned collectible gifts »: account.getUniqueGiftChatThemes</a>
...
* <a href="payments.getUniqueStarGift.html" name="payments.getUniqueStarGift">Obtain info about a collectible gift » using a slug obtained from a collectible gift link »: payments.getUniqueStarGift</a>
...
* <a href="messages.getSavedDialogsByID.html" name="messages.getSavedDialogsByID">Obtain information about specific saved message dialogs » or monoforum topics »: messages.getSavedDialogsByID</a>
...
* <a href="invokeWithReCaptcha.html" name="invokeWithReCaptcha">Official clients only: re-execute a method call that required reCAPTCHA verification via a RECAPTCHA_CHECK_%s__%s, where the first placeholder is the action, and the second one is the reCAPTCHA key ID: invokeWithReCaptcha</a>
...
* <a href="phone.deleteConferenceCallParticipants.html" name="phone.deleteConferenceCallParticipants">Remove participants from a conference call: phone.deleteConferenceCallParticipants</a>
...
* <a href="stories.updateAlbum.html" name="stories.updateAlbum">Rename a story albums », or add, delete or reorder stories in it: stories.updateAlbum</a>
...
* <a href="stories.reorderAlbums.html" name="stories.reorderAlbums">Reorder story albums on a profile »: stories.reorderAlbums</a>

* <a href="payments.reorderStarGiftCollections.html" name="payments.reorderStarGiftCollections">Reorder the star gift collections » on an owned peer's profile: payments.reorderStarGiftCollections</a>
...
* <a href="account.resolveBusinessChatLink.html" name="account.resolveBusinessChatLink">Resolve a business chat deep link »: account.resolveBusinessChatLink</a>
...
* <a href="help.getPromoData.html" name="help.getPromoData">Returns a set of useful suggestions and PSA/MTProxy sponsored peers, see here » for more info: help.getPromoData</a>
...
* <a href="messages.getSavedDialogs.html" name="messages.getSavedDialogs">Returns the current saved dialog list » or monoforum topic list »: messages.getSavedDialogs</a>
...
* <a href="premium.getUserBoosts.html" name="premium.getUserBoosts">Returns the lists of boost that were applied to a channel/supergroup by a specific user (admins only): premium.getUserBoosts</a>
...
* <a href="help.getTimezonesList.html" name="help.getTimezonesList">Returns timezone information that may be used elsewhere in the API, such as to set Telegram Business opening hours »: help.getTimezonesList</a>
...
* <a href="messages.savePreparedInlineMessage.html" name="messages.savePreparedInlineMessage">Save a prepared inline message, to be shared by the user of the mini app using a web_app_send_prepared_message event: messages.savePreparedInlineMessage</a>
...
* <a href="messages.searchStickers.html" name="messages.searchStickers">Search for stickers using AI-powered keyword search: messages.searchStickers</a>
...
* <a href="messages.sendQuickReplyMessages.html" name="messages.sendQuickReplyMessages">Send a quick reply shortcut »: messages.sendQuickReplyMessages</a>
...
* <a href="messages.sendPaidReaction.html" name="messages.sendPaidReaction">Sends one or more paid Telegram Star reactions », transferring Telegram Stars » to a channel's balance: messages.sendPaidReaction</a>
...
* <a href="channels.setEmojiStickers.html" name="channels.setEmojiStickers">Set a custom emoji stickerset for supergroups. Only usable after reaching at least the boost level » specified in the group_emoji_stickers_level_min » config parameter: channels.setEmojiStickers</a>
...
* <a href="account.updateBusinessAwayMessage.html" name="account.updateBusinessAwayMessage">Set a list of Telegram Business away messages: account.updateBusinessAwayMessage</a>

* <a href="account.updateBusinessGreetingMessage.html" name="account.updateBusinessGreetingMessage">Set a list of Telegram Business greeting messages: account.updateBusinessGreetingMessage</a>

* <a href="account.setAccountTTL.html" name="account.setAccountTTL">Set account self-destruction period: account.setAccountTTL</a>

* <a href="channels.updateEmojiStatus.html" name="channels.updateEmojiStatus">Set an emoji status for a channel or supergroup: channels.updateEmojiStatus</a>
...
* <a href="smsjobs.updateSettings.html" name="smsjobs.updateSettings">Update SMS job settings (official clients only): smsjobs.updateSettings</a>

* <a href="messages.updateDialogFilter.html" name="messages.updateDialogFilter">Update folder: messages.updateDialogFilter</a>

* <a href="account.updateBirthday.html" name="account.updateBirthday">Update our birthday, see here » for more info: account.updateBirthday</a>
...
* <a href="messages.updateSavedReactionTag.html" name="messages.updateSavedReactionTag">Update the description of a saved message tag »: messages.updateSavedReactionTag</a>

* <a href="stickers.changeSticker.html" name="stickers.changeSticker">Update the keywords, emojis or mask coordinates of a sticker: stickers.changeSticker</a>
...
* <a href="messages.uploadEncryptedFile.html" name="messages.uploadEncryptedFile">Upload encrypted file and associate it to a secret chat (without actually sending it to the chat): messages.uploadEncryptedFile</a>
...
* <a href="bots.setCustomVerification.html" name="bots.setCustomVerification">Verify a user or chat on behalf of an organization »: bots.setCustomVerification</a>
