...
```
$inputStorePaymentAuthCode = ['_' => 'inputStorePaymentAuthCode', 'restore' => Bool, 'phone_number' => 'string', 'phone_code_hash' => 'string', 'premium_days' => int, 'currency' => 'string', 'amount' => long];
```  
