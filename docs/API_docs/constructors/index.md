...
***
<br><br>[$account.chatThemes](/API_docs/constructors/account.chatThemes.html) = \['hash' => [long](/API_docs/types/long.html), 'themes' => \[[ChatTheme](/API_docs/types/ChatTheme.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], 'next_offset' => [string](/API_docs/types/string.html), \];<a name="account.chatThemes"></a>  

***
<br><br>[$account.chatThemesNotModified](/API_docs/constructors/account.chatThemesNotModified.html) = \[\];<a name="account.chatThemesNotModified"></a>  
...
***
<br><br>[$account.passkeyRegistrationOptions](/API_docs/constructors/account.passkeyRegistrationOptions.html) = \['options' => [DataJSON](/API_docs/types/DataJSON.html), \];<a name="account.passkeyRegistrationOptions"></a>  

***
<br><br>[$account.passkeys](/API_docs/constructors/account.passkeys.html) = \['passkeys' => \[[Passkey](/API_docs/types/Passkey.html)\], \];<a name="account.passkeys"></a>  
...
***
<br><br>[$account.savedMusicIds](/API_docs/constructors/account.savedMusicIds.html) = \['ids' => \[[long](/API_docs/types/long.html)\], \];<a name="account.savedMusicIds"></a>  

***
<br><br>[$account.savedMusicIdsNotModified](/API_docs/constructors/account.savedMusicIdsNotModified.html) = \[\];<a name="account.savedMusicIdsNotModified"></a>  
...
***
<br><br>[$account.webBrowserSettings](/API_docs/constructors/account.webBrowserSettings.html) = \['open_external_browser' => [Bool](/API_docs/types/Bool.html), 'display_close_button' => [Bool](/API_docs/types/Bool.html), 'external_exceptions' => \[[WebDomainException](/API_docs/types/WebDomainException.html)\], 'inapp_exceptions' => \[[WebDomainException](/API_docs/types/WebDomainException.html)\], 'hash' => [long](/API_docs/types/long.html), \];<a name="account.webBrowserSettings"></a>  

***
<br><br>[$account.webBrowserSettingsNotModified](/API_docs/constructors/account.webBrowserSettingsNotModified.html) = \[\];<a name="account.webBrowserSettingsNotModified"></a>  

***
<br><br>[$accountDaysTTL](/API_docs/constructors/accountDaysTTL.html) = \['days' => [int](/API_docs/types/int.html), \];<a name="accountDaysTTL"></a>  

***
<br><br>[$aiComposeTone](/API_docs/constructors/aiComposeTone.html) = \['creator' => [Bool](/API_docs/types/Bool.html), 'id' => [long](/API_docs/types/long.html), 'access_hash' => [long](/API_docs/types/long.html), 'slug' => [string](/API_docs/types/string.html), 'title' => [string](/API_docs/types/string.html), 'emoji_id' => [long](/API_docs/types/long.html), 'prompt' => [string](/API_docs/types/string.html), 'installs_count' => [int](/API_docs/types/int.html), 'author_id' => [long](/API_docs/types/long.html), 'example_english' => [AiComposeToneExample](/API_docs/types/AiComposeToneExample.html), \];<a name="aiComposeTone"></a>  

***
<br><br>[$aiComposeToneDefault](/API_docs/constructors/aiComposeToneDefault.html) = \['tone' => [string](/API_docs/types/string.html), 'emoji_id' => [long](/API_docs/types/long.html), 'title' => [string](/API_docs/types/string.html), \];<a name="aiComposeToneDefault"></a>  

***
<br><br>[$aiComposeToneExample](/API_docs/constructors/aiComposeToneExample.html) = \['from' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'to' => [TextWithEntities](/API_docs/types/TextWithEntities.html), \];<a name="aiComposeToneExample"></a>  

***
<br><br>[$aicompose.tones](/API_docs/constructors/aicompose.tones.html) = \['hash' => [long](/API_docs/types/long.html), 'tones' => \[[AiComposeTone](/API_docs/types/AiComposeTone.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="aicompose.tones"></a>  

***
<br><br>[$aicompose.tonesNotModified](/API_docs/constructors/aicompose.tonesNotModified.html) = \[\];<a name="aicompose.tonesNotModified"></a>  
...
***
<br><br>[$auctionBidLevel](/API_docs/constructors/auctionBidLevel.html) = \['pos' => [int](/API_docs/types/int.html), 'amount' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), \];<a name="auctionBidLevel"></a>  
...
***
<br><br>[$auth.passkeyLoginOptions](/API_docs/constructors/auth.passkeyLoginOptions.html) = \['options' => [DataJSON](/API_docs/types/DataJSON.html), \];<a name="auth.passkeyLoginOptions"></a>  
...
***
<br><br>[$auth.sentCodePaymentRequired](/API_docs/constructors/auth.sentCodePaymentRequired.html) = \['store_product' => [string](/API_docs/types/string.html), 'phone_code_hash' => [string](/API_docs/types/string.html), 'support_email_address' => [string](/API_docs/types/string.html), 'support_email_subject' => [string](/API_docs/types/string.html), 'premium_days' => [int](/API_docs/types/int.html), 'currency' => [string](/API_docs/types/string.html), 'amount' => [long](/API_docs/types/long.html), \];<a name="auth.sentCodePaymentRequired"></a>  
...
***
<br><br>[$botInlineMessageRichMessage](/API_docs/constructors/botInlineMessageRichMessage.html) = \['reply_markup' => [ReplyMarkup](/API_docs/types/ReplyMarkup.html), 'rich_message' => [RichMessage](/API_docs/types/RichMessage.html), \];<a name="botInlineMessageRichMessage"></a>  
...
***
<br><br>[$bots.accessSettings](/API_docs/constructors/bots.accessSettings.html) = \['restricted' => [Bool](/API_docs/types/Bool.html), 'add_users' => \[[User](/API_docs/types/User.html)\], \];<a name="bots.accessSettings"></a>  
...
***
<br><br>[$bots.exportedBotToken](/API_docs/constructors/bots.exportedBotToken.html) = \['token' => [string](/API_docs/types/string.html), \];<a name="bots.exportedBotToken"></a>  
...
***
<br><br>[$bots.requestedButton](/API_docs/constructors/bots.requestedButton.html) = \['webapp_req_id' => [string](/API_docs/types/string.html), \];<a name="bots.requestedButton"></a>  
...
***
<br><br>[$channelAdminLogEventActionParticipantEditRank](/API_docs/constructors/channelAdminLogEventActionParticipantEditRank.html) = \['user_id' => [long](/API_docs/types/long.html), 'prev_rank' => [string](/API_docs/types/string.html), 'new_rank' => [string](/API_docs/types/string.html), \];<a name="channelAdminLogEventActionParticipantEditRank"></a>  
...
***
<br><br>[$channelParticipant](/API_docs/constructors/channelParticipant.html) = \['user_id' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), 'subscription_until_date' => [int](/API_docs/types/int.html), 'rank' => [string](/API_docs/types/string.html), \];<a name="channelParticipant"></a>  
...
***
<br><br>[$chatParticipant](/API_docs/constructors/chatParticipant.html) = \['user_id' => [long](/API_docs/types/long.html), 'inviter_id' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), 'rank' => [string](/API_docs/types/string.html), \];<a name="chatParticipant"></a>  

***
<br><br>[$chatParticipantAdmin](/API_docs/constructors/chatParticipantAdmin.html) = \['user_id' => [long](/API_docs/types/long.html), 'inviter_id' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), 'rank' => [string](/API_docs/types/string.html), \];<a name="chatParticipantAdmin"></a>  

***
<br><br>[$chatParticipantCreator](/API_docs/constructors/chatParticipantCreator.html) = \['user_id' => [long](/API_docs/types/long.html), 'rank' => [string](/API_docs/types/string.html), \];<a name="chatParticipantCreator"></a>  
...
***
<br><br>[$chatTheme](/API_docs/constructors/chatTheme.html) = \['emoticon' => [string](/API_docs/types/string.html), \];<a name="chatTheme"></a>  

***
<br><br>[$chatThemeUniqueGift](/API_docs/constructors/chatThemeUniqueGift.html) = \['gift' => [StarGift](/API_docs/types/StarGift.html), 'theme_settings' => \[[ThemeSettings](/API_docs/types/ThemeSettings.html)\], \];<a name="chatThemeUniqueGift"></a>  
...
***
<br><br>[$connectedBot](/API_docs/constructors/connectedBot.html) = \['bot_id' => [long](/API_docs/types/long.html), 'recipients' => [BusinessBotRecipients](/API_docs/types/BusinessBotRecipients.html), 'rights' => [BusinessBotRights](/API_docs/types/BusinessBotRights.html), 'device' => [string](/API_docs/types/string.html), 'date' => [int](/API_docs/types/int.html), 'location' => [string](/API_docs/types/string.html), \];<a name="connectedBot"></a>  
...
***
<br><br>[$forumTopic](/API_docs/constructors/forumTopic.html) = \['my' => [Bool](/API_docs/types/Bool.html), 'closed' => [Bool](/API_docs/types/Bool.html), 'pinned' => [Bool](/API_docs/types/Bool.html), 'short' => [Bool](/API_docs/types/Bool.html), 'hidden' => [Bool](/API_docs/types/Bool.html), 'title_missing' => [Bool](/API_docs/types/Bool.html), 'id' => [int](/API_docs/types/int.html), 'date' => [int](/API_docs/types/int.html), 'peer' => [long](/API_docs/types/long.html), 'title' => [string](/API_docs/types/string.html), 'icon_color' => [int](/API_docs/types/int.html), 'icon_emoji_id' => [long](/API_docs/types/long.html), 'top_message' => [int](/API_docs/types/int.html), 'read_inbox_max_id' => [int](/API_docs/types/int.html), 'read_outbox_max_id' => [int](/API_docs/types/int.html), 'unread_count' => [int](/API_docs/types/int.html), 'unread_mentions_count' => [int](/API_docs/types/int.html), 'unread_reactions_count' => [int](/API_docs/types/int.html), 'unread_poll_votes_count' => [int](/API_docs/types/int.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'notify_settings' => [PeerNotifySettings](/API_docs/types/PeerNotifySettings.html), 'draft' => [DraftMessage](/API_docs/types/DraftMessage.html), \];<a name="forumTopic"></a>  
...
***
<br><br>[$groupCall](/API_docs/constructors/groupCall.html) = \['join_muted' => [Bool](/API_docs/types/Bool.html), 'can_change_join_muted' => [Bool](/API_docs/types/Bool.html), 'join_date_asc' => [Bool](/API_docs/types/Bool.html), 'schedule_start_subscribed' => [Bool](/API_docs/types/Bool.html), 'can_start_video' => [Bool](/API_docs/types/Bool.html), 'record_video_active' => [Bool](/API_docs/types/Bool.html), 'rtmp_stream' => [Bool](/API_docs/types/Bool.html), 'listeners_hidden' => [Bool](/API_docs/types/Bool.html), 'conference' => [Bool](/API_docs/types/Bool.html), 'creator' => [Bool](/API_docs/types/Bool.html), 'messages_enabled' => [Bool](/API_docs/types/Bool.html), 'can_change_messages_enabled' => [Bool](/API_docs/types/Bool.html), 'min' => [Bool](/API_docs/types/Bool.html), 'id' => [long](/API_docs/types/long.html), 'access_hash' => [long](/API_docs/types/long.html), 'participants_count' => [int](/API_docs/types/int.html), 'title' => [string](/API_docs/types/string.html), 'stream_dc_id' => [int](/API_docs/types/int.html), 'record_start_date' => [int](/API_docs/types/int.html), 'schedule_date' => [int](/API_docs/types/int.html), 'unmuted_video_count' => [int](/API_docs/types/int.html), 'unmuted_video_limit' => [int](/API_docs/types/int.html), 'version' => [int](/API_docs/types/int.html), 'invite_link' => [string](/API_docs/types/string.html), 'send_paid_messages_stars' => [long](/API_docs/types/long.html), 'default_send_as' => [Peer](/API_docs/types/Peer.html), \];<a name="groupCall"></a>  
...
***
<br><br>[$inputAiComposeToneDefault](/API_docs/constructors/inputAiComposeToneDefault.html) = \['tone' => [string](/API_docs/types/string.html), \];<a name="inputAiComposeToneDefault"></a>  
...
***
<br><br>[$inputBotInlineMessageRichMessage](/API_docs/constructors/inputBotInlineMessageRichMessage.html) = \['reply_markup' => [ReplyMarkup](/API_docs/types/ReplyMarkup.html), 'rich_message' => [InputRichMessage](/API_docs/types/InputRichMessage.html), \];<a name="inputBotInlineMessageRichMessage"></a>  
...
***
<br><br>[$inputChatTheme](/API_docs/constructors/inputChatTheme.html) = \['emoticon' => [string](/API_docs/types/string.html), \];<a name="inputChatTheme"></a>  

***
<br><br>[$inputChatThemeEmpty](/API_docs/constructors/inputChatThemeEmpty.html) = \[\];<a name="inputChatThemeEmpty"></a>  

***
<br><br>[$inputChatThemeUniqueGift](/API_docs/constructors/inputChatThemeUniqueGift.html) = \['slug' => [string](/API_docs/types/string.html), \];<a name="inputChatThemeUniqueGift"></a>  
...
***
<br><br>[$inputInvoicePremiumAuthCode](/API_docs/constructors/inputInvoicePremiumAuthCode.html) = \['purpose' => [InputStorePaymentPurpose](/API_docs/types/InputStorePaymentPurpose.html), \];<a name="inputInvoicePremiumAuthCode"></a>  
...
***
<br><br>[$inputInvoiceStarGiftAuctionBid](/API_docs/constructors/inputInvoiceStarGiftAuctionBid.html) = \['hide_name' => [Bool](/API_docs/types/Bool.html), 'update_bid' => [Bool](/API_docs/types/Bool.html), 'peer' => [InputPeer](/API_docs/types/InputPeer.html), 'gift_id' => [long](/API_docs/types/long.html), 'bid_amount' => [long](/API_docs/types/long.html), 'message' => [TextWithEntities](/API_docs/types/TextWithEntities.html), \];<a name="inputInvoiceStarGiftAuctionBid"></a>  

***
<br><br>[$inputInvoiceStarGiftDropOriginalDetails](/API_docs/constructors/inputInvoiceStarGiftDropOriginalDetails.html) = \['stargift' => [InputSavedStarGift](/API_docs/types/InputSavedStarGift.html), \];<a name="inputInvoiceStarGiftDropOriginalDetails"></a>  
...
***
<br><br>[$inputMediaPhoto](/API_docs/constructors/inputMediaPhoto.html) = \['spoiler' => [Bool](/API_docs/types/Bool.html), 'live_photo' => [Bool](/API_docs/types/Bool.html), 'id' => [InputPhoto](/API_docs/types/InputPhoto.html), 'ttl_seconds' => [int](/API_docs/types/int.html), 'video' => [InputDocument](/API_docs/types/InputDocument.html), \];<a name="inputMediaPhoto"></a>  
...
***
<br><br>[$inputMediaPoll](/API_docs/constructors/inputMediaPoll.html) = \['poll' => [Poll](/API_docs/types/Poll.html), 'correct_answers' => \[[int](/API_docs/types/int.html)\], 'attached_media' => [InputMedia](/API_docs/types/InputMedia.html), 'solution' => [string](/API_docs/types/string.html), 'solution_entities' => \[[MessageEntity](/API_docs/types/MessageEntity.html)\], 'solution_media' => [InputMedia](/API_docs/types/InputMedia.html), \];<a name="inputMediaPoll"></a>  

***
<br><br>[$inputMediaStakeDice](/API_docs/constructors/inputMediaStakeDice.html) = \['game_hash' => [string](/API_docs/types/string.html), 'ton_amount' => [long](/API_docs/types/long.html), 'client_seed' => [bytes](/API_docs/types/bytes.html), \];<a name="inputMediaStakeDice"></a>  
...
***
<br><br>[$inputMediaUploadedPhoto](/API_docs/constructors/inputMediaUploadedPhoto.html) = \['spoiler' => [Bool](/API_docs/types/Bool.html), 'live_photo' => [Bool](/API_docs/types/Bool.html), 'file' => [InputFile](/API_docs/types/InputFile.html), 'stickers' => \[[InputDocument](/API_docs/types/InputDocument.html)\], 'ttl_seconds' => [int](/API_docs/types/int.html), 'video' => [InputDocument](/API_docs/types/InputDocument.html), \];<a name="inputMediaUploadedPhoto"></a>  
...
***
<br><br>[$inputMessageReadMetric](/API_docs/constructors/inputMessageReadMetric.html) = \['msg_id' => [int](/API_docs/types/int.html), 'view_id' => [long](/API_docs/types/long.html), 'time_in_view_ms' => [int](/API_docs/types/int.html), 'active_time_in_view_ms' => [int](/API_docs/types/int.html), 'height_to_viewport_ratio_permille' => [int](/API_docs/types/int.html), 'seen_range_ratio_permille' => [int](/API_docs/types/int.html), \];<a name="inputMessageReadMetric"></a>  
...
***
<br><br>[$inputMessagesFilterPoll](/API_docs/constructors/inputMessagesFilterPoll.html) = \[\];<a name="inputMessagesFilterPoll"></a>  
...
***
<br><br>[$inputPageBlockMap](/API_docs/constructors/inputPageBlockMap.html) = \['geo' => [InputGeoPoint](/API_docs/types/InputGeoPoint.html), 'zoom' => [int](/API_docs/types/int.html), 'w' => [int](/API_docs/types/int.html), 'h' => [int](/API_docs/types/int.html), 'caption' => [PageCaption](/API_docs/types/PageCaption.html), \];<a name="inputPageBlockMap"></a>  

***
<br><br>[$inputPasskeyCredentialFirebasePNV](/API_docs/constructors/inputPasskeyCredentialFirebasePNV.html) = \['pnv_token' => [string](/API_docs/types/string.html), \];<a name="inputPasskeyCredentialFirebasePNV"></a>  

***
<br><br>[$inputPasskeyCredentialPublicKey](/API_docs/constructors/inputPasskeyCredentialPublicKey.html) = \['id' => [string](/API_docs/types/string.html), 'raw_id' => [string](/API_docs/types/string.html), 'response' => [InputPasskeyResponse](/API_docs/types/InputPasskeyResponse.html), \];<a name="inputPasskeyCredentialPublicKey"></a>  

***
<br><br>[$inputPasskeyResponseLogin](/API_docs/constructors/inputPasskeyResponseLogin.html) = \['client_data' => [DataJSON](/API_docs/types/DataJSON.html), 'authenticator_data' => [bytes](/API_docs/types/bytes.html), 'signature' => [bytes](/API_docs/types/bytes.html), 'user_handle' => [string](/API_docs/types/string.html), \];<a name="inputPasskeyResponseLogin"></a>  

***
<br><br>[$inputPasskeyResponseRegister](/API_docs/constructors/inputPasskeyResponseRegister.html) = \['client_data' => [DataJSON](/API_docs/types/DataJSON.html), 'attestation_data' => [bytes](/API_docs/types/bytes.html), \];<a name="inputPasskeyResponseRegister"></a>  
...
***
<br><br>[$inputPeerColorCollectible](/API_docs/constructors/inputPeerColorCollectible.html) = \['collectible_id' => [long](/API_docs/types/long.html), \];<a name="inputPeerColorCollectible"></a>  
...
***
<br><br>[$inputPhoneContact](/API_docs/constructors/inputPhoneContact.html) = \['client_id' => [long](/API_docs/types/long.html), 'phone' => [string](/API_docs/types/string.html), 'first_name' => [string](/API_docs/types/string.html), 'last_name' => [string](/API_docs/types/string.html), 'note' => [TextWithEntities](/API_docs/types/TextWithEntities.html), \];<a name="inputPhoneContact"></a>  
...
***
<br><br>[$inputPollAnswer](/API_docs/constructors/inputPollAnswer.html) = \['text' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'media' => [InputMedia](/API_docs/types/InputMedia.html), \];<a name="inputPollAnswer"></a>  
...
***
<br><br>[$inputPrivacyKeySavedMusic](/API_docs/constructors/inputPrivacyKeySavedMusic.html) = \[\];<a name="inputPrivacyKeySavedMusic"></a>  
...
***
<br><br>[$inputRichFileDocument](/API_docs/constructors/inputRichFileDocument.html) = \['id' => [string](/API_docs/types/string.html), 'document' => [InputDocument](/API_docs/types/InputDocument.html), \];<a name="inputRichFileDocument"></a>  

***
<br><br>[$inputRichFilePhoto](/API_docs/constructors/inputRichFilePhoto.html) = \['id' => [string](/API_docs/types/string.html), 'photo' => [InputPhoto](/API_docs/types/InputPhoto.html), \];<a name="inputRichFilePhoto"></a>  

***
<br><br>[$inputRichMessage](/API_docs/constructors/inputRichMessage.html) = \['rtl' => [Bool](/API_docs/types/Bool.html), 'noautolink' => [Bool](/API_docs/types/Bool.html), 'blocks' => \[[PageBlock](/API_docs/types/PageBlock.html)\], 'photos' => \[[InputPhoto](/API_docs/types/InputPhoto.html)\], 'documents' => \[[InputDocument](/API_docs/types/InputDocument.html)\], 'users' => \[[InputUser](/API_docs/types/InputUser.html)\], \];<a name="inputRichMessage"></a>  

***
<br><br>[$inputRichMessageHTML](/API_docs/constructors/inputRichMessageHTML.html) = \['rtl' => [Bool](/API_docs/types/Bool.html), 'noautolink' => [Bool](/API_docs/types/Bool.html), 'html' => [string](/API_docs/types/string.html), 'files' => \[[InputRichFile](/API_docs/types/InputRichFile.html)\], \];<a name="inputRichMessageHTML"></a>  

***
<br><br>[$inputRichMessageMarkdown](/API_docs/constructors/inputRichMessageMarkdown.html) = \['rtl' => [Bool](/API_docs/types/Bool.html), 'noautolink' => [Bool](/API_docs/types/Bool.html), 'markdown' => [string](/API_docs/types/string.html), 'files' => \[[InputRichFile](/API_docs/types/InputRichFile.html)\], \];<a name="inputRichMessageMarkdown"></a>  
...
***
<br><br>[$inputStarGiftAuction](/API_docs/constructors/inputStarGiftAuction.html) = \['gift_id' => [long](/API_docs/types/long.html), \];<a name="inputStarGiftAuction"></a>  

***
<br><br>[$inputStarGiftAuctionSlug](/API_docs/constructors/inputStarGiftAuctionSlug.html) = \['slug' => [string](/API_docs/types/string.html), \];<a name="inputStarGiftAuctionSlug"></a>  
...
***
<br><br>[$inputStorePaymentAuthCode](/API_docs/constructors/inputStorePaymentAuthCode.html) = \['restore' => [Bool](/API_docs/types/Bool.html), 'phone_number' => [string](/API_docs/types/string.html), 'phone_code_hash' => [string](/API_docs/types/string.html), 'premium_days' => [int](/API_docs/types/int.html), 'currency' => [string](/API_docs/types/string.html), 'amount' => [long](/API_docs/types/long.html), \];<a name="inputStorePaymentAuthCode"></a>  
...
***
<br><br>[$inputStorePaymentStarsTopup](/API_docs/constructors/inputStorePaymentStarsTopup.html) = \['stars' => [long](/API_docs/types/long.html), 'currency' => [string](/API_docs/types/string.html), 'amount' => [long](/API_docs/types/long.html), 'spend_purpose_peer' => [InputPeer](/API_docs/types/InputPeer.html), \];<a name="inputStorePaymentStarsTopup"></a>  
...
***
<br><br>[$joinChatBotResultApproved](/API_docs/constructors/joinChatBotResultApproved.html) = \[\];<a name="joinChatBotResultApproved"></a>  

***
<br><br>[$joinChatBotResultDeclined](/API_docs/constructors/joinChatBotResultDeclined.html) = \[\];<a name="joinChatBotResultDeclined"></a>  

***
<br><br>[$joinChatBotResultQueued](/API_docs/constructors/joinChatBotResultQueued.html) = \[\];<a name="joinChatBotResultQueued"></a>  

***
<br><br>[$joinChatBotResultWebView](/API_docs/constructors/joinChatBotResultWebView.html) = \['url' => [string](/API_docs/types/string.html), \];<a name="joinChatBotResultWebView"></a>  
...
***
<br><br>[$message](/API_docs/constructors/message.html) = \['out' => [Bool](/API_docs/types/Bool.html), 'mentioned' => [Bool](/API_docs/types/Bool.html), 'media_unread' => [Bool](/API_docs/types/Bool.html), 'silent' => [Bool](/API_docs/types/Bool.html), 'post' => [Bool](/API_docs/types/Bool.html), 'from_scheduled' => [Bool](/API_docs/types/Bool.html), 'legacy' => [Bool](/API_docs/types/Bool.html), 'edit_hide' => [Bool](/API_docs/types/Bool.html), 'pinned' => [Bool](/API_docs/types/Bool.html), 'noforwards' => [Bool](/API_docs/types/Bool.html), 'invert_media' => [Bool](/API_docs/types/Bool.html), 'offline' => [Bool](/API_docs/types/Bool.html), 'video_processing_pending' => [Bool](/API_docs/types/Bool.html), 'paid_suggested_post_stars' => [Bool](/API_docs/types/Bool.html), 'paid_suggested_post_ton' => [Bool](/API_docs/types/Bool.html), 'id' => [int](/API_docs/types/int.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'from_boosts_applied' => [int](/API_docs/types/int.html), 'from_rank' => [string](/API_docs/types/string.html), 'peer_id' => [Peer](/API_docs/types/Peer.html), 'saved_peer_id' => [Peer](/API_docs/types/Peer.html), 'fwd_from' => [MessageFwdHeader](/API_docs/types/MessageFwdHeader.html), 'via_bot_id' => [long](/API_docs/types/long.html), 'via_business_bot_id' => [long](/API_docs/types/long.html), 'guestchat_via_from' => [Peer](/API_docs/types/Peer.html), 'reply_to' => [MessageReplyHeader](/API_docs/types/MessageReplyHeader.html), 'date' => [int](/API_docs/types/int.html), 'message' => [string](/API_docs/types/string.html), 'media' => [MessageMedia](/API_docs/types/MessageMedia.html), 'reply_markup' => [ReplyMarkup](/API_docs/types/ReplyMarkup.html), 'entities' => \[[MessageEntity](/API_docs/types/MessageEntity.html)\], 'views' => [int](/API_docs/types/int.html), 'forwards' => [int](/API_docs/types/int.html), 'replies' => [MessageReplies](/API_docs/types/MessageReplies.html), 'edit_date' => [int](/API_docs/types/int.html), 'post_author' => [string](/API_docs/types/string.html), 'grouped_id' => [long](/API_docs/types/long.html), 'reactions' => [MessageReactions](/API_docs/types/MessageReactions.html), 'restriction_reason' => \[[RestrictionReason](/API_docs/types/RestrictionReason.html)\], 'ttl_period' => [int](/API_docs/types/int.html), 'quick_reply_shortcut_id' => [int](/API_docs/types/int.html), 'effect' => [long](/API_docs/types/long.html), 'factcheck' => [FactCheck](/API_docs/types/FactCheck.html), 'report_delivery_until_date' => [int](/API_docs/types/int.html), 'paid_message_stars' => [long](/API_docs/types/long.html), 'suggested_post' => [SuggestedPost](/API_docs/types/SuggestedPost.html), 'schedule_repeat_period' => [int](/API_docs/types/int.html), 'summary_from_language' => [string](/API_docs/types/string.html), 'rich_message' => [RichMessage](/API_docs/types/RichMessage.html), \];<a name="message"></a>  
...
***
<br><br>[$messageActionManagedBotCreated](/API_docs/constructors/messageActionManagedBotCreated.html) = \['bot_id' => [long](/API_docs/types/long.html), \];<a name="messageActionManagedBotCreated"></a>  

***
<br><br>[$messageActionNewCreatorPending](/API_docs/constructors/messageActionNewCreatorPending.html) = \['new_creator_id' => [long](/API_docs/types/long.html), \];<a name="messageActionNewCreatorPending"></a>  

***
<br><br>[$messageActionNoForwardsRequest](/API_docs/constructors/messageActionNoForwardsRequest.html) = \['expired' => [Bool](/API_docs/types/Bool.html), 'prev_value' => [Bool](/API_docs/types/Bool.html), 'new_value' => [Bool](/API_docs/types/Bool.html), \];<a name="messageActionNoForwardsRequest"></a>  

***
<br><br>[$messageActionNoForwardsToggle](/API_docs/constructors/messageActionNoForwardsToggle.html) = \['prev_value' => [Bool](/API_docs/types/Bool.html), 'new_value' => [Bool](/API_docs/types/Bool.html), \];<a name="messageActionNoForwardsToggle"></a>  
...
***
<br><br>[$messageActionPollAppendAnswer](/API_docs/constructors/messageActionPollAppendAnswer.html) = \['answer' => [PollAnswer](/API_docs/types/PollAnswer.html), \];<a name="messageActionPollAppendAnswer"></a>  

***
<br><br>[$messageActionPollDeleteAnswer](/API_docs/constructors/messageActionPollDeleteAnswer.html) = \['answer' => [PollAnswer](/API_docs/types/PollAnswer.html), \];<a name="messageActionPollDeleteAnswer"></a>  
...
***
<br><br>[$messageActionSetChatTheme](/API_docs/constructors/messageActionSetChatTheme.html) = \['theme' => [ChatTheme](/API_docs/types/ChatTheme.html), \];<a name="messageActionSetChatTheme"></a>  
...
***
<br><br>[$messageActionStarGift](/API_docs/constructors/messageActionStarGift.html) = \['name_hidden' => [Bool](/API_docs/types/Bool.html), 'saved' => [Bool](/API_docs/types/Bool.html), 'converted' => [Bool](/API_docs/types/Bool.html), 'upgraded' => [Bool](/API_docs/types/Bool.html), 'refunded' => [Bool](/API_docs/types/Bool.html), 'can_upgrade' => [Bool](/API_docs/types/Bool.html), 'prepaid_upgrade' => [Bool](/API_docs/types/Bool.html), 'upgrade_separate' => [Bool](/API_docs/types/Bool.html), 'auction_acquired' => [Bool](/API_docs/types/Bool.html), 'gift' => [StarGift](/API_docs/types/StarGift.html), 'message' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'convert_stars' => [long](/API_docs/types/long.html), 'upgrade_msg_id' => [int](/API_docs/types/int.html), 'upgrade_stars' => [long](/API_docs/types/long.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'peer' => [long](/API_docs/types/long.html), 'saved_id' => [long](/API_docs/types/long.html), 'prepaid_upgrade_hash' => [string](/API_docs/types/string.html), 'gift_msg_id' => [int](/API_docs/types/int.html), 'to_id' => [Peer](/API_docs/types/Peer.html), 'gift_num' => [int](/API_docs/types/int.html), \];<a name="messageActionStarGift"></a>  

***
<br><br>[$messageActionStarGiftPurchaseOffer](/API_docs/constructors/messageActionStarGiftPurchaseOffer.html) = \['accepted' => [Bool](/API_docs/types/Bool.html), 'declined' => [Bool](/API_docs/types/Bool.html), 'gift' => [StarGift](/API_docs/types/StarGift.html), 'price' => [StarsAmount](/API_docs/types/StarsAmount.html), 'expires_at' => [int](/API_docs/types/int.html), \];<a name="messageActionStarGiftPurchaseOffer"></a>  
...
***
<br><br>[$messageActionTopicCreate](/API_docs/constructors/messageActionTopicCreate.html) = \['title_missing' => [Bool](/API_docs/types/Bool.html), 'title' => [string](/API_docs/types/string.html), 'icon_color' => [int](/API_docs/types/int.html), 'icon_emoji_id' => [long](/API_docs/types/long.html), \];<a name="messageActionTopicCreate"></a>  
...
***
<br><br>[$messageEntityDiffDelete](/API_docs/constructors/messageEntityDiffDelete.html) = \['offset' => [int](/API_docs/types/int.html), 'length' => [int](/API_docs/types/int.html), \];<a name="messageEntityDiffDelete"></a>  

***
<br><br>[$messageEntityDiffInsert](/API_docs/constructors/messageEntityDiffInsert.html) = \['offset' => [int](/API_docs/types/int.html), 'length' => [int](/API_docs/types/int.html), \];<a name="messageEntityDiffInsert"></a>  

***
<br><br>[$messageEntityDiffReplace](/API_docs/constructors/messageEntityDiffReplace.html) = \['offset' => [int](/API_docs/types/int.html), 'length' => [int](/API_docs/types/int.html), 'old_text' => [string](/API_docs/types/string.html), \];<a name="messageEntityDiffReplace"></a>  
...
***
<br><br>[$messageEntityFormattedDate](/API_docs/constructors/messageEntityFormattedDate.html) = \['relative' => [Bool](/API_docs/types/Bool.html), 'short_time' => [Bool](/API_docs/types/Bool.html), 'long_time' => [Bool](/API_docs/types/Bool.html), 'short_date' => [Bool](/API_docs/types/Bool.html), 'long_date' => [Bool](/API_docs/types/Bool.html), 'day_of_week' => [Bool](/API_docs/types/Bool.html), 'offset' => [int](/API_docs/types/int.html), 'length' => [int](/API_docs/types/int.html), 'date' => [int](/API_docs/types/int.html), \];<a name="messageEntityFormattedDate"></a>  
...
***
<br><br>[$messageMediaDice](/API_docs/constructors/messageMediaDice.html) = \['value' => [int](/API_docs/types/int.html), 'emoticon' => [string](/API_docs/types/string.html), 'game_outcome' => [messages.EmojiGameOutcome](/API_docs/types/messages.EmojiGameOutcome.html), \];<a name="messageMediaDice"></a>  
...
***
<br><br>[$messageMediaPhoto](/API_docs/constructors/messageMediaPhoto.html) = \['spoiler' => [Bool](/API_docs/types/Bool.html), 'live_photo' => [Bool](/API_docs/types/Bool.html), 'photo' => [Photo](/API_docs/types/Photo.html), 'ttl_seconds' => [int](/API_docs/types/int.html), 'video' => [Document](/API_docs/types/Document.html), \];<a name="messageMediaPhoto"></a>  

***
<br><br>[$messageMediaPoll](/API_docs/constructors/messageMediaPoll.html) = \['poll' => [Poll](/API_docs/types/Poll.html), 'results' => [PollResults](/API_docs/types/PollResults.html), 'attached_media' => [MessageMedia](/API_docs/types/MessageMedia.html), \];<a name="messageMediaPoll"></a>  
...
***
<br><br>[$messageMediaVideoStream](/API_docs/constructors/messageMediaVideoStream.html) = \['rtmp_stream' => [Bool](/API_docs/types/Bool.html), 'call' => [InputGroupCall](/API_docs/types/InputGroupCall.html), \];<a name="messageMediaVideoStream"></a>  
...
***
<br><br>[$messageReplyHeader](/API_docs/constructors/messageReplyHeader.html) = \['reply_to_scheduled' => [Bool](/API_docs/types/Bool.html), 'forum_topic' => [Bool](/API_docs/types/Bool.html), 'quote' => [Bool](/API_docs/types/Bool.html), 'reply_to_ephemeral' => [Bool](/API_docs/types/Bool.html), 'reply_to_msg_id' => [int](/API_docs/types/int.html), 'reply_to_peer_id' => [Peer](/API_docs/types/Peer.html), 'reply_from' => [MessageFwdHeader](/API_docs/types/MessageFwdHeader.html), 'reply_media' => [MessageMedia](/API_docs/types/MessageMedia.html), 'reply_to_top_id' => [int](/API_docs/types/int.html), 'quote_text' => [string](/API_docs/types/string.html), 'quote_entities' => \[[MessageEntity](/API_docs/types/MessageEntity.html)\], 'quote_offset' => [int](/API_docs/types/int.html), 'todo_item_id' => [int](/API_docs/types/int.html), 'poll_option' => [bytes](/API_docs/types/bytes.html), \];<a name="messageReplyHeader"></a>  
...
***
<br><br>[$messages.emojiGameDiceInfo](/API_docs/constructors/messages.emojiGameDiceInfo.html) = \['game_hash' => [string](/API_docs/types/string.html), 'prev_stake' => [long](/API_docs/types/long.html), 'current_streak' => [int](/API_docs/types/int.html), 'params' => \[[int](/API_docs/types/int.html)\], 'plays_left' => [int](/API_docs/types/int.html), \];<a name="messages.emojiGameDiceInfo"></a>  

***
<br><br>[$messages.emojiGameOutcome](/API_docs/constructors/messages.emojiGameOutcome.html) = \['seed' => [bytes](/API_docs/types/bytes.html), 'stake_ton_amount' => [long](/API_docs/types/long.html), 'ton_amount' => [long](/API_docs/types/long.html), \];<a name="messages.emojiGameOutcome"></a>  

***
<br><br>[$messages.emojiGameUnavailable](/API_docs/constructors/messages.emojiGameUnavailable.html) = \[\];<a name="messages.emojiGameUnavailable"></a>  
...
***
<br><br>[$messages.messages](/API_docs/constructors/messages.messages.html) = \['messages' => \[[Message](/API_docs/types/Message.html)\], 'topics' => \[[ForumTopic](/API_docs/types/ForumTopic.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="messages.messages"></a>  
...
***
<br><br>[$messages.messagesSlice](/API_docs/constructors/messages.messagesSlice.html) = \['inexact' => [Bool](/API_docs/types/Bool.html), 'count' => [int](/API_docs/types/int.html), 'next_rate' => [int](/API_docs/types/int.html), 'offset_id_offset' => [int](/API_docs/types/int.html), 'search_flood' => [SearchPostsFlood](/API_docs/types/SearchPostsFlood.html), 'messages' => \[[Message](/API_docs/types/Message.html)\], 'topics' => \[[ForumTopic](/API_docs/types/ForumTopic.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="messages.messagesSlice"></a>  
...
***
<br><br>[$messages.webPagePreview](/API_docs/constructors/messages.webPagePreview.html) = \['media' => [MessageMedia](/API_docs/types/MessageMedia.html), 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="messages.webPagePreview"></a>  
...
***
<br><br>[$pageBlockHeading1](/API_docs/constructors/pageBlockHeading1.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageBlockHeading1"></a>  

***
<br><br>[$pageBlockHeading2](/API_docs/constructors/pageBlockHeading2.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageBlockHeading2"></a>  

***
<br><br>[$pageBlockHeading3](/API_docs/constructors/pageBlockHeading3.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageBlockHeading3"></a>  

***
<br><br>[$pageBlockHeading4](/API_docs/constructors/pageBlockHeading4.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageBlockHeading4"></a>  

***
<br><br>[$pageBlockHeading5](/API_docs/constructors/pageBlockHeading5.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageBlockHeading5"></a>  

***
<br><br>[$pageBlockHeading6](/API_docs/constructors/pageBlockHeading6.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageBlockHeading6"></a>  
...
***
<br><br>[$pageBlockMath](/API_docs/constructors/pageBlockMath.html) = \['source' => [string](/API_docs/types/string.html), \];<a name="pageBlockMath"></a>  

***
<br><br>[$pageBlockOrderedList](/API_docs/constructors/pageBlockOrderedList.html) = \['reversed' => [Bool](/API_docs/types/Bool.html), 'items' => \[[PageListOrderedItem](/API_docs/types/PageListOrderedItem.html)\], 'start' => [int](/API_docs/types/int.html), 'type' => [string](/API_docs/types/string.html), \];<a name="pageBlockOrderedList"></a>  
...
***
<br><br>[$pageBlockPhoto](/API_docs/constructors/pageBlockPhoto.html) = \['spoiler' => [Bool](/API_docs/types/Bool.html), 'photo_id' => [long](/API_docs/types/long.html), 'caption' => [PageCaption](/API_docs/types/PageCaption.html), 'url' => [string](/API_docs/types/string.html), 'webpage_id' => [long](/API_docs/types/long.html), \];<a name="pageBlockPhoto"></a>  
...
***
<br><br>[$pageListItemBlocks](/API_docs/constructors/pageListItemBlocks.html) = \['checkbox' => [Bool](/API_docs/types/Bool.html), 'checked' => [Bool](/API_docs/types/Bool.html), 'blocks' => \[[PageBlock](/API_docs/types/PageBlock.html)\], \];<a name="pageListItemBlocks"></a>  

***
<br><br>[$pageListItemText](/API_docs/constructors/pageListItemText.html) = \['checkbox' => [Bool](/API_docs/types/Bool.html), 'checked' => [Bool](/API_docs/types/Bool.html), 'text' => [RichText](/API_docs/types/RichText.html), \];<a name="pageListItemText"></a>  

***
<br><br>[$pageListOrderedItemBlocks](/API_docs/constructors/pageListOrderedItemBlocks.html) = \['checkbox' => [Bool](/API_docs/types/Bool.html), 'checked' => [Bool](/API_docs/types/Bool.html), 'num' => [string](/API_docs/types/string.html), 'blocks' => \[[PageBlock](/API_docs/types/PageBlock.html)\], 'value' => [int](/API_docs/types/int.html), 'type' => [string](/API_docs/types/string.html), \];<a name="pageListOrderedItemBlocks"></a>  

***
<br><br>[$pageListOrderedItemText](/API_docs/constructors/pageListOrderedItemText.html) = \['checkbox' => [Bool](/API_docs/types/Bool.html), 'checked' => [Bool](/API_docs/types/Bool.html), 'num' => [string](/API_docs/types/string.html), 'text' => [RichText](/API_docs/types/RichText.html), 'value' => [int](/API_docs/types/int.html), 'type' => [string](/API_docs/types/string.html), \];<a name="pageListOrderedItemText"></a>  
...
***
<br><br>[$passkey](/API_docs/constructors/passkey.html) = \['id' => [string](/API_docs/types/string.html), 'name' => [string](/API_docs/types/string.html), 'date' => [int](/API_docs/types/int.html), 'software_emoji_id' => [long](/API_docs/types/long.html), 'last_usage_date' => [int](/API_docs/types/int.html), \];<a name="passkey"></a>  
...
***
<br><br>[$payments.checkCanSendGiftResultFail](/API_docs/constructors/payments.checkCanSendGiftResultFail.html) = \['reason' => [TextWithEntities](/API_docs/types/TextWithEntities.html), \];<a name="payments.checkCanSendGiftResultFail"></a>  

***
<br><br>[$payments.checkCanSendGiftResultOk](/API_docs/constructors/payments.checkCanSendGiftResultOk.html) = \[\];<a name="payments.checkCanSendGiftResultOk"></a>  

***
<br><br>[$payments.checkedGiftCode](/API_docs/constructors/payments.checkedGiftCode.html) = \['via_giveaway' => [Bool](/API_docs/types/Bool.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'giveaway_msg_id' => [int](/API_docs/types/int.html), 'to_id' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), 'days' => [int](/API_docs/types/int.html), 'used_date' => [int](/API_docs/types/int.html), 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="payments.checkedGiftCode"></a>  
...
***
<br><br>[$payments.starGiftActiveAuctions](/API_docs/constructors/payments.starGiftActiveAuctions.html) = \['auctions' => \[[StarGiftActiveAuctionState](/API_docs/types/StarGiftActiveAuctionState.html)\], 'users' => \[[User](/API_docs/types/User.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], \];<a name="payments.starGiftActiveAuctions"></a>  

***
<br><br>[$payments.starGiftActiveAuctionsNotModified](/API_docs/constructors/payments.starGiftActiveAuctionsNotModified.html) = \[\];<a name="payments.starGiftActiveAuctionsNotModified"></a>  

***
<br><br>[$payments.starGiftAuctionAcquiredGifts](/API_docs/constructors/payments.starGiftAuctionAcquiredGifts.html) = \['gifts' => \[[StarGiftAuctionAcquiredGift](/API_docs/types/StarGiftAuctionAcquiredGift.html)\], 'users' => \[[User](/API_docs/types/User.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], \];<a name="payments.starGiftAuctionAcquiredGifts"></a>  

***
<br><br>[$payments.starGiftAuctionState](/API_docs/constructors/payments.starGiftAuctionState.html) = \['gift' => [StarGift](/API_docs/types/StarGift.html), 'state' => [StarGiftAuctionState](/API_docs/types/StarGiftAuctionState.html), 'user_state' => [StarGiftAuctionUserState](/API_docs/types/StarGiftAuctionUserState.html), 'timeout' => [int](/API_docs/types/int.html), 'users' => \[[User](/API_docs/types/User.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], \];<a name="payments.starGiftAuctionState"></a>  
...
***
<br><br>[$payments.starGiftUpgradeAttributes](/API_docs/constructors/payments.starGiftUpgradeAttributes.html) = \['attributes' => \[[StarGiftAttribute](/API_docs/types/StarGiftAttribute.html)\], \];<a name="payments.starGiftUpgradeAttributes"></a>  

***
<br><br>[$payments.starGiftUpgradePreview](/API_docs/constructors/payments.starGiftUpgradePreview.html) = \['sample_attributes' => \[[StarGiftAttribute](/API_docs/types/StarGiftAttribute.html)\], 'prices' => \[[StarGiftUpgradePrice](/API_docs/types/StarGiftUpgradePrice.html)\], 'next_prices' => \[[StarGiftUpgradePrice](/API_docs/types/StarGiftUpgradePrice.html)\], \];<a name="payments.starGiftUpgradePreview"></a>  
...
***
<br><br>[$payments.uniqueStarGift](/API_docs/constructors/payments.uniqueStarGift.html) = \['gift' => [StarGift](/API_docs/types/StarGift.html), 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="payments.uniqueStarGift"></a>  

***
<br><br>[$payments.uniqueStarGiftValueInfo](/API_docs/constructors/payments.uniqueStarGiftValueInfo.html) = \['last_sale_on_fragment' => [Bool](/API_docs/types/Bool.html), 'value_is_average' => [Bool](/API_docs/types/Bool.html), 'currency' => [string](/API_docs/types/string.html), 'value' => [long](/API_docs/types/long.html), 'initial_sale_date' => [int](/API_docs/types/int.html), 'initial_sale_stars' => [long](/API_docs/types/long.html), 'initial_sale_price' => [long](/API_docs/types/long.html), 'last_sale_date' => [int](/API_docs/types/int.html), 'last_sale_price' => [long](/API_docs/types/long.html), 'floor_price' => [long](/API_docs/types/long.html), 'average_price' => [long](/API_docs/types/long.html), 'listed_count' => [int](/API_docs/types/int.html), 'fragment_listed_count' => [int](/API_docs/types/int.html), 'fragment_listed_url' => [string](/API_docs/types/string.html), \];<a name="payments.uniqueStarGiftValueInfo"></a>  
...
***
<br><br>[$peerColorCollectible](/API_docs/constructors/peerColorCollectible.html) = \['collectible_id' => [long](/API_docs/types/long.html), 'gift_emoji_id' => [long](/API_docs/types/long.html), 'background_emoji_id' => [long](/API_docs/types/long.html), 'accent_color' => [int](/API_docs/types/int.html), 'colors' => \[[int](/API_docs/types/int.html)\], 'dark_accent_color' => [int](/API_docs/types/int.html), 'dark_colors' => \[[int](/API_docs/types/int.html)\], \];<a name="peerColorCollectible"></a>  
...
***
<br><br>[$phone.groupCallStars](/API_docs/constructors/phone.groupCallStars.html) = \['total_stars' => [long](/API_docs/types/long.html), 'top_donors' => \[[GroupCallDonor](/API_docs/types/GroupCallDonor.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="phone.groupCallStars"></a>  
...
***
<br><br>[$poll](/API_docs/constructors/poll.html) = \['id' => [long](/API_docs/types/long.html), 'closed' => [Bool](/API_docs/types/Bool.html), 'public_voters' => [Bool](/API_docs/types/Bool.html), 'multiple_choice' => [Bool](/API_docs/types/Bool.html), 'quiz' => [Bool](/API_docs/types/Bool.html), 'open_answers' => [Bool](/API_docs/types/Bool.html), 'revoting_disabled' => [Bool](/API_docs/types/Bool.html), 'shuffle_answers' => [Bool](/API_docs/types/Bool.html), 'hide_results_until_close' => [Bool](/API_docs/types/Bool.html), 'creator' => [Bool](/API_docs/types/Bool.html), 'subscribers_only' => [Bool](/API_docs/types/Bool.html), 'question' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'answers' => \[[PollAnswer](/API_docs/types/PollAnswer.html)\], 'close_period' => [int](/API_docs/types/int.html), 'close_date' => [int](/API_docs/types/int.html), 'countries_iso2' => \[[string](/API_docs/types/string.html)\], 'hash' => [long](/API_docs/types/long.html), \];<a name="poll"></a>  

***
<br><br>[$pollAnswer](/API_docs/constructors/pollAnswer.html) = \['text' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'option' => [bytes](/API_docs/types/bytes.html), 'media' => [MessageMedia](/API_docs/types/MessageMedia.html), 'added_by' => [Peer](/API_docs/types/Peer.html), 'date' => [int](/API_docs/types/int.html), \];<a name="pollAnswer"></a>  

***
<br><br>[$pollAnswerVoters](/API_docs/constructors/pollAnswerVoters.html) = \['chosen' => [Bool](/API_docs/types/Bool.html), 'correct' => [Bool](/API_docs/types/Bool.html), 'option' => [bytes](/API_docs/types/bytes.html), 'voters' => [int](/API_docs/types/int.html), 'recent_voters' => \[[Peer](/API_docs/types/Peer.html)\], \];<a name="pollAnswerVoters"></a>  

***
<br><br>[$pollResults](/API_docs/constructors/pollResults.html) = \['min' => [Bool](/API_docs/types/Bool.html), 'has_unread_votes' => [Bool](/API_docs/types/Bool.html), 'can_view_stats' => [Bool](/API_docs/types/Bool.html), 'results' => \[[PollAnswerVoters](/API_docs/types/PollAnswerVoters.html)\], 'total_voters' => [int](/API_docs/types/int.html), 'recent_voters' => \[[Peer](/API_docs/types/Peer.html)\], 'solution' => [string](/API_docs/types/string.html), 'solution_entities' => \[[MessageEntity](/API_docs/types/MessageEntity.html)\], 'solution_media' => [MessageMedia](/API_docs/types/MessageMedia.html), \];<a name="pollResults"></a>  
...
***
<br><br>[$privacyKeySavedMusic](/API_docs/constructors/privacyKeySavedMusic.html) = \[\];<a name="privacyKeySavedMusic"></a>  
...
***
<br><br>[$profileTabFiles](/API_docs/constructors/profileTabFiles.html) = \[\];<a name="profileTabFiles"></a>  

***
<br><br>[$profileTabGifs](/API_docs/constructors/profileTabGifs.html) = \[\];<a name="profileTabGifs"></a>  

***
<br><br>[$profileTabGifts](/API_docs/constructors/profileTabGifts.html) = \[\];<a name="profileTabGifts"></a>  

***
<br><br>[$profileTabLinks](/API_docs/constructors/profileTabLinks.html) = \[\];<a name="profileTabLinks"></a>  

***
<br><br>[$profileTabMedia](/API_docs/constructors/profileTabMedia.html) = \[\];<a name="profileTabMedia"></a>  

***
<br><br>[$profileTabMusic](/API_docs/constructors/profileTabMusic.html) = \[\];<a name="profileTabMusic"></a>  

***
<br><br>[$profileTabPosts](/API_docs/constructors/profileTabPosts.html) = \[\];<a name="profileTabPosts"></a>  

***
<br><br>[$profileTabVoice](/API_docs/constructors/profileTabVoice.html) = \[\];<a name="profileTabVoice"></a>  
...
***
<br><br>[$requestPeerTypeCreateBot](/API_docs/constructors/requestPeerTypeCreateBot.html) = \['bot_managed' => [Bool](/API_docs/types/Bool.html), 'suggested_name' => [string](/API_docs/types/string.html), 'suggested_username' => [string](/API_docs/types/string.html), \];<a name="requestPeerTypeCreateBot"></a>  
...
***
<br><br>[$savedStarGift](/API_docs/constructors/savedStarGift.html) = \['name_hidden' => [Bool](/API_docs/types/Bool.html), 'unsaved' => [Bool](/API_docs/types/Bool.html), 'refunded' => [Bool](/API_docs/types/Bool.html), 'can_upgrade' => [Bool](/API_docs/types/Bool.html), 'pinned_to_top' => [Bool](/API_docs/types/Bool.html), 'upgrade_separate' => [Bool](/API_docs/types/Bool.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'date' => [int](/API_docs/types/int.html), 'gift' => [StarGift](/API_docs/types/StarGift.html), 'message' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'msg_id' => [int](/API_docs/types/int.html), 'saved_id' => [long](/API_docs/types/long.html), 'convert_stars' => [long](/API_docs/types/long.html), 'upgrade_stars' => [long](/API_docs/types/long.html), 'can_export_at' => [int](/API_docs/types/int.html), 'transfer_stars' => [long](/API_docs/types/long.html), 'can_transfer_at' => [int](/API_docs/types/int.html), 'can_resell_at' => [int](/API_docs/types/int.html), 'collection_id' => \[[int](/API_docs/types/int.html)\], 'prepaid_upgrade_hash' => [string](/API_docs/types/string.html), 'drop_original_details_stars' => [long](/API_docs/types/long.html), 'gift_num' => [int](/API_docs/types/int.html), 'can_craft_at' => [int](/API_docs/types/int.html), \];<a name="savedStarGift"></a>  

***
<br><br>[$searchPostsFlood](/API_docs/constructors/searchPostsFlood.html) = \['query_is_free' => [Bool](/API_docs/types/Bool.html), 'total_daily' => [int](/API_docs/types/int.html), 'remains' => [int](/API_docs/types/int.html), 'wait_till' => [int](/API_docs/types/int.html), 'stars_amount' => [long](/API_docs/types/long.html), \];<a name="searchPostsFlood"></a>  
...
***
<br><br>[$starGift](/API_docs/constructors/starGift.html) = \['limited' => [Bool](/API_docs/types/Bool.html), 'sold_out' => [Bool](/API_docs/types/Bool.html), 'birthday' => [Bool](/API_docs/types/Bool.html), 'require_premium' => [Bool](/API_docs/types/Bool.html), 'limited_per_user' => [Bool](/API_docs/types/Bool.html), 'peer_color_available' => [Bool](/API_docs/types/Bool.html), 'auction' => [Bool](/API_docs/types/Bool.html), 'id' => [long](/API_docs/types/long.html), 'sticker' => [Document](/API_docs/types/Document.html), 'stars' => [long](/API_docs/types/long.html), 'availability_remains' => [int](/API_docs/types/int.html), 'availability_total' => [int](/API_docs/types/int.html), 'availability_resale' => [long](/API_docs/types/long.html), 'convert_stars' => [long](/API_docs/types/long.html), 'first_sale_date' => [int](/API_docs/types/int.html), 'last_sale_date' => [int](/API_docs/types/int.html), 'upgrade_stars' => [long](/API_docs/types/long.html), 'resell_min_stars' => [long](/API_docs/types/long.html), 'title' => [string](/API_docs/types/string.html), 'released_by' => [Peer](/API_docs/types/Peer.html), 'per_user_total' => [int](/API_docs/types/int.html), 'per_user_remains' => [int](/API_docs/types/int.html), 'locked_until_date' => [int](/API_docs/types/int.html), 'auction_slug' => [string](/API_docs/types/string.html), 'gifts_per_round' => [int](/API_docs/types/int.html), 'auction_start_date' => [int](/API_docs/types/int.html), 'upgrade_variants' => [int](/API_docs/types/int.html), 'background' => [StarGiftBackground](/API_docs/types/StarGiftBackground.html), \];<a name="starGift"></a>  

***
<br><br>[$starGiftActiveAuctionState](/API_docs/constructors/starGiftActiveAuctionState.html) = \['gift' => [StarGift](/API_docs/types/StarGift.html), 'state' => [StarGiftAuctionState](/API_docs/types/StarGiftAuctionState.html), 'user_state' => [StarGiftAuctionUserState](/API_docs/types/StarGiftAuctionUserState.html), \];<a name="starGiftActiveAuctionState"></a>  

***
<br><br>[$starGiftAttributeBackdrop](/API_docs/constructors/starGiftAttributeBackdrop.html) = \['name' => [string](/API_docs/types/string.html), 'backdrop_id' => [int](/API_docs/types/int.html), 'center_color' => [int](/API_docs/types/int.html), 'edge_color' => [int](/API_docs/types/int.html), 'pattern_color' => [int](/API_docs/types/int.html), 'text_color' => [int](/API_docs/types/int.html), 'rarity' => [StarGiftAttributeRarity](/API_docs/types/StarGiftAttributeRarity.html), \];<a name="starGiftAttributeBackdrop"></a>  
...
***
<br><br>[$starGiftAttributeModel](/API_docs/constructors/starGiftAttributeModel.html) = \['crafted' => [Bool](/API_docs/types/Bool.html), 'name' => [string](/API_docs/types/string.html), 'document' => [Document](/API_docs/types/Document.html), 'rarity' => [StarGiftAttributeRarity](/API_docs/types/StarGiftAttributeRarity.html), \];<a name="starGiftAttributeModel"></a>  
...
***
<br><br>[$starGiftAttributePattern](/API_docs/constructors/starGiftAttributePattern.html) = \['name' => [string](/API_docs/types/string.html), 'document' => [Document](/API_docs/types/Document.html), 'rarity' => [StarGiftAttributeRarity](/API_docs/types/StarGiftAttributeRarity.html), \];<a name="starGiftAttributePattern"></a>  

***
<br><br>[$starGiftAttributeRarity](/API_docs/constructors/starGiftAttributeRarity.html) = \['permille' => [int](/API_docs/types/int.html), \];<a name="starGiftAttributeRarity"></a>  

***
<br><br>[$starGiftAttributeRarityEpic](/API_docs/constructors/starGiftAttributeRarityEpic.html) = \[\];<a name="starGiftAttributeRarityEpic"></a>  

***
<br><br>[$starGiftAttributeRarityLegendary](/API_docs/constructors/starGiftAttributeRarityLegendary.html) = \[\];<a name="starGiftAttributeRarityLegendary"></a>  

***
<br><br>[$starGiftAttributeRarityRare](/API_docs/constructors/starGiftAttributeRarityRare.html) = \[\];<a name="starGiftAttributeRarityRare"></a>  

***
<br><br>[$starGiftAttributeRarityUncommon](/API_docs/constructors/starGiftAttributeRarityUncommon.html) = \[\];<a name="starGiftAttributeRarityUncommon"></a>  

***
<br><br>[$starGiftAuctionAcquiredGift](/API_docs/constructors/starGiftAuctionAcquiredGift.html) = \['name_hidden' => [Bool](/API_docs/types/Bool.html), 'peer' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), 'bid_amount' => [long](/API_docs/types/long.html), 'round' => [int](/API_docs/types/int.html), 'pos' => [int](/API_docs/types/int.html), 'message' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'gift_num' => [int](/API_docs/types/int.html), \];<a name="starGiftAuctionAcquiredGift"></a>  

***
<br><br>[$starGiftAuctionRound](/API_docs/constructors/starGiftAuctionRound.html) = \['num' => [int](/API_docs/types/int.html), 'duration' => [int](/API_docs/types/int.html), \];<a name="starGiftAuctionRound"></a>  

***
<br><br>[$starGiftAuctionRoundExtendable](/API_docs/constructors/starGiftAuctionRoundExtendable.html) = \['num' => [int](/API_docs/types/int.html), 'duration' => [int](/API_docs/types/int.html), 'extend_top' => [int](/API_docs/types/int.html), 'extend_window' => [int](/API_docs/types/int.html), \];<a name="starGiftAuctionRoundExtendable"></a>  

***
<br><br>[$starGiftAuctionState](/API_docs/constructors/starGiftAuctionState.html) = \['version' => [int](/API_docs/types/int.html), 'start_date' => [int](/API_docs/types/int.html), 'end_date' => [int](/API_docs/types/int.html), 'min_bid_amount' => [long](/API_docs/types/long.html), 'bid_levels' => \[[AuctionBidLevel](/API_docs/types/AuctionBidLevel.html)\], 'top_bidders' => \[[long](/API_docs/types/long.html)\], 'next_round_at' => [int](/API_docs/types/int.html), 'last_gift_num' => [int](/API_docs/types/int.html), 'gifts_left' => [int](/API_docs/types/int.html), 'current_round' => [int](/API_docs/types/int.html), 'total_rounds' => [int](/API_docs/types/int.html), 'rounds' => \[[StarGiftAuctionRound](/API_docs/types/StarGiftAuctionRound.html)\], \];<a name="starGiftAuctionState"></a>  

***
<br><br>[$starGiftAuctionStateFinished](/API_docs/constructors/starGiftAuctionStateFinished.html) = \['start_date' => [int](/API_docs/types/int.html), 'end_date' => [int](/API_docs/types/int.html), 'average_price' => [long](/API_docs/types/long.html), 'listed_count' => [int](/API_docs/types/int.html), 'fragment_listed_count' => [int](/API_docs/types/int.html), 'fragment_listed_url' => [string](/API_docs/types/string.html), \];<a name="starGiftAuctionStateFinished"></a>  

***
<br><br>[$starGiftAuctionStateNotModified](/API_docs/constructors/starGiftAuctionStateNotModified.html) = \[\];<a name="starGiftAuctionStateNotModified"></a>  

***
<br><br>[$starGiftAuctionUserState](/API_docs/constructors/starGiftAuctionUserState.html) = \['returned' => [Bool](/API_docs/types/Bool.html), 'bid_amount' => [long](/API_docs/types/long.html), 'bid_date' => [int](/API_docs/types/int.html), 'min_bid_amount' => [long](/API_docs/types/long.html), 'bid_peer' => [Peer](/API_docs/types/Peer.html), 'acquired_count' => [int](/API_docs/types/int.html), \];<a name="starGiftAuctionUserState"></a>  

***
<br><br>[$starGiftBackground](/API_docs/constructors/starGiftBackground.html) = \['center_color' => [int](/API_docs/types/int.html), 'edge_color' => [int](/API_docs/types/int.html), 'text_color' => [int](/API_docs/types/int.html), \];<a name="starGiftBackground"></a>  
...
***
<br><br>[$starGiftUnique](/API_docs/constructors/starGiftUnique.html) = \['require_premium' => [Bool](/API_docs/types/Bool.html), 'resale_ton_only' => [Bool](/API_docs/types/Bool.html), 'theme_available' => [Bool](/API_docs/types/Bool.html), 'burned' => [Bool](/API_docs/types/Bool.html), 'crafted' => [Bool](/API_docs/types/Bool.html), 'id' => [long](/API_docs/types/long.html), 'gift_id' => [long](/API_docs/types/long.html), 'title' => [string](/API_docs/types/string.html), 'slug' => [string](/API_docs/types/string.html), 'num' => [int](/API_docs/types/int.html), 'owner_id' => [Peer](/API_docs/types/Peer.html), 'owner_name' => [string](/API_docs/types/string.html), 'owner_address' => [string](/API_docs/types/string.html), 'attributes' => \[[StarGiftAttribute](/API_docs/types/StarGiftAttribute.html)\], 'availability_issued' => [int](/API_docs/types/int.html), 'availability_total' => [int](/API_docs/types/int.html), 'gift_address' => [string](/API_docs/types/string.html), 'resell_amount' => \[[StarsAmount](/API_docs/types/StarsAmount.html)\], 'released_by' => [Peer](/API_docs/types/Peer.html), 'value_amount' => [long](/API_docs/types/long.html), 'value_currency' => [string](/API_docs/types/string.html), 'value_usd_amount' => [long](/API_docs/types/long.html), 'theme_peer' => [Peer](/API_docs/types/Peer.html), 'peer_color' => [PeerColor](/API_docs/types/PeerColor.html), 'host_id' => [Peer](/API_docs/types/Peer.html), 'offer_min_stars' => [int](/API_docs/types/int.html), 'craft_chance_permille' => [int](/API_docs/types/int.html), \];<a name="starGiftUnique"></a>  

***
<br><br>[$starGiftUpgradePrice](/API_docs/constructors/starGiftUpgradePrice.html) = \['date' => [int](/API_docs/types/int.html), 'upgrade_stars' => [long](/API_docs/types/long.html), \];<a name="starGiftUpgradePrice"></a>  
...
***
<br><br>[$stats.pollStats](/API_docs/constructors/stats.pollStats.html) = \['votes_graph' => [StatsGraph](/API_docs/types/StatsGraph.html), \];<a name="stats.pollStats"></a>  
...
***
<br><br>[$stories.albums](/API_docs/constructors/stories.albums.html) = \['hash' => [long](/API_docs/types/long.html), 'albums' => \[[StoryAlbum](/API_docs/types/StoryAlbum.html)\], \];<a name="stories.albums"></a>  

***
<br><br>[$stories.albumsNotModified](/API_docs/constructors/stories.albumsNotModified.html) = \[\];<a name="stories.albumsNotModified"></a>  
...
***
<br><br>[$storyAlbum](/API_docs/constructors/storyAlbum.html) = \['album_id' => [int](/API_docs/types/int.html), 'title' => [string](/API_docs/types/string.html), 'icon_photo' => [Photo](/API_docs/types/Photo.html), 'icon_video' => [Document](/API_docs/types/Document.html), \];<a name="storyAlbum"></a>  
...
***
<br><br>[$storyItemSkipped](/API_docs/constructors/storyItemSkipped.html) = \['close_friends' => [Bool](/API_docs/types/Bool.html), 'live' => [Bool](/API_docs/types/Bool.html), 'id' => [int](/API_docs/types/int.html), 'date' => [int](/API_docs/types/int.html), 'expire_date' => [int](/API_docs/types/int.html), \];<a name="storyItemSkipped"></a>  
...
***
<br><br>[$textAutoEmail](/API_docs/constructors/textAutoEmail.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textAutoEmail"></a>  

***
<br><br>[$textAutoPhone](/API_docs/constructors/textAutoPhone.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textAutoPhone"></a>  

***
<br><br>[$textAutoUrl](/API_docs/constructors/textAutoUrl.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textAutoUrl"></a>  

***
<br><br>[$textBankCard](/API_docs/constructors/textBankCard.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textBankCard"></a>  
...
***
<br><br>[$textCustomEmoji](/API_docs/constructors/textCustomEmoji.html) = \['document_id' => [long](/API_docs/types/long.html), 'alt' => [string](/API_docs/types/string.html), \];<a name="textCustomEmoji"></a>  
...
***
<br><br>[$textHashtag](/API_docs/constructors/textHashtag.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textHashtag"></a>  
...
***
<br><br>[$textMath](/API_docs/constructors/textMath.html) = \['source' => [string](/API_docs/types/string.html), \];<a name="textMath"></a>  

***
<br><br>[$textMention](/API_docs/constructors/textMention.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textMention"></a>  

***
<br><br>[$textMentionName](/API_docs/constructors/textMentionName.html) = \['text' => [RichText](/API_docs/types/RichText.html), 'user_id' => [long](/API_docs/types/long.html), \];<a name="textMentionName"></a>  
...
***
<br><br>[$textSpoiler](/API_docs/constructors/textSpoiler.html) = \['text' => [RichText](/API_docs/types/RichText.html), \];<a name="textSpoiler"></a>  
...
***
<br><br>[$todoCompletion](/API_docs/constructors/todoCompletion.html) = \['id' => [int](/API_docs/types/int.html), 'completed_by' => [Peer](/API_docs/types/Peer.html), 'date' => [int](/API_docs/types/int.html), \];<a name="todoCompletion"></a>  
...
***
<br><br>[$topPeerCategoryBotsGuestChat](/API_docs/constructors/topPeerCategoryBotsGuestChat.html) = \[\];<a name="topPeerCategoryBotsGuestChat"></a>  
...
***
<br><br>[$updateAiComposeTones](/API_docs/constructors/updateAiComposeTones.html) = \[\];<a name="updateAiComposeTones"></a>  
...
***
<br><br>[$updateBotGuestChatQuery](/API_docs/constructors/updateBotGuestChatQuery.html) = \['query_id' => [long](/API_docs/types/long.html), 'message' => [Message](/API_docs/types/Message.html), 'reference_messages' => \[[Message](/API_docs/types/Message.html)\], 'qts' => [int](/API_docs/types/int.html), \];<a name="updateBotGuestChatQuery"></a>  
...
***
<br><br>[$updateChatParticipantRank](/API_docs/constructors/updateChatParticipantRank.html) = \['chat_id' => [long](/API_docs/types/long.html), 'user_id' => [long](/API_docs/types/long.html), 'rank' => [string](/API_docs/types/string.html), 'version' => [int](/API_docs/types/int.html), \];<a name="updateChatParticipantRank"></a>  
...
***
<br><br>[$updateEmojiGameInfo](/API_docs/constructors/updateEmojiGameInfo.html) = \['info' => [messages.EmojiGameInfo](/API_docs/types/messages.EmojiGameInfo.html), \];<a name="updateEmojiGameInfo"></a>  
...
***
<br><br>[$updateGroupCall](/API_docs/constructors/updateGroupCall.html) = \['live_story' => [Bool](/API_docs/types/Bool.html), 'peer' => [long](/API_docs/types/long.html), 'call' => [GroupCall](/API_docs/types/GroupCall.html), \];<a name="updateGroupCall"></a>  
...
***
<br><br>[$updateGroupCallEncryptedMessage](/API_docs/constructors/updateGroupCallEncryptedMessage.html) = \['call' => [InputGroupCall](/API_docs/types/InputGroupCall.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'encrypted_message' => [bytes](/API_docs/types/bytes.html), \];<a name="updateGroupCallEncryptedMessage"></a>  

***
<br><br>[$updateGroupCallMessage](/API_docs/constructors/updateGroupCallMessage.html) = \['call' => [InputGroupCall](/API_docs/types/InputGroupCall.html), 'message' => [GroupCallMessage](/API_docs/types/GroupCallMessage.html), \];<a name="updateGroupCallMessage"></a>  
...
***
<br><br>[$updateJoinChatWebViewDecision](/API_docs/constructors/updateJoinChatWebViewDecision.html) = \['peer' => [long](/API_docs/types/long.html), 'query_id' => [long](/API_docs/types/long.html), 'result' => [JoinChatBotResult](/API_docs/types/JoinChatBotResult.html), \];<a name="updateJoinChatWebViewDecision"></a>  
...
***
<br><br>[$updateManagedBot](/API_docs/constructors/updateManagedBot.html) = \['user_id' => [long](/API_docs/types/long.html), 'bot_id' => [long](/API_docs/types/long.html), 'qts' => [int](/API_docs/types/int.html), \];<a name="updateManagedBot"></a>  
...
***
<br><br>[$updateMessagePoll](/API_docs/constructors/updateMessagePoll.html) = \['peer' => [long](/API_docs/types/long.html), 'msg_id' => [int](/API_docs/types/int.html), 'top_msg_id' => [int](/API_docs/types/int.html), 'poll_id' => [long](/API_docs/types/long.html), 'poll' => [Poll](/API_docs/types/Poll.html), 'results' => [PollResults](/API_docs/types/PollResults.html), \];<a name="updateMessagePoll"></a>  

***
<br><br>[$updateMessagePollVote](/API_docs/constructors/updateMessagePollVote.html) = \['poll_id' => [long](/API_docs/types/long.html), 'peer' => [long](/API_docs/types/long.html), 'options' => \[[bytes](/API_docs/types/bytes.html)\], 'positions' => \[[int](/API_docs/types/int.html)\], 'qts' => [int](/API_docs/types/int.html), \];<a name="updateMessagePollVote"></a>  
...
***
<br><br>[$updateNewBotConnection](/API_docs/constructors/updateNewBotConnection.html) = \['confirmed' => [Bool](/API_docs/types/Bool.html), 'bot_id' => [long](/API_docs/types/long.html), 'date' => [int](/API_docs/types/int.html), 'device' => [string](/API_docs/types/string.html), 'location' => [string](/API_docs/types/string.html), \];<a name="updateNewBotConnection"></a>  
...
***
<br><br>[$updatePinnedForumTopic](/API_docs/constructors/updatePinnedForumTopic.html) = \['pinned' => [Bool](/API_docs/types/Bool.html), 'peer' => [long](/API_docs/types/long.html), 'topic_id' => [int](/API_docs/types/int.html), \];<a name="updatePinnedForumTopic"></a>  

***
<br><br>[$updatePinnedForumTopics](/API_docs/constructors/updatePinnedForumTopics.html) = \['peer' => [long](/API_docs/types/long.html), 'order' => \[[int](/API_docs/types/int.html)\], \];<a name="updatePinnedForumTopics"></a>  
...
***
<br><br>[$updateReadHistoryInbox](/API_docs/constructors/updateReadHistoryInbox.html) = \['folder_id' => [int](/API_docs/types/int.html), 'peer' => [long](/API_docs/types/long.html), 'top_msg_id' => [int](/API_docs/types/int.html), 'max_id' => [int](/API_docs/types/int.html), 'still_unread_count' => [int](/API_docs/types/int.html), 'pts' => [int](/API_docs/types/int.html), 'pts_count' => [int](/API_docs/types/int.html), \];<a name="updateReadHistoryInbox"></a>  
...
***
<br><br>[$updateStarGiftAuctionState](/API_docs/constructors/updateStarGiftAuctionState.html) = \['gift_id' => [long](/API_docs/types/long.html), 'state' => [StarGiftAuctionState](/API_docs/types/StarGiftAuctionState.html), \];<a name="updateStarGiftAuctionState"></a>  

***
<br><br>[$updateStarGiftAuctionUserState](/API_docs/constructors/updateStarGiftAuctionUserState.html) = \['gift_id' => [long](/API_docs/types/long.html), 'user_state' => [StarGiftAuctionUserState](/API_docs/types/StarGiftAuctionUserState.html), \];<a name="updateStarGiftAuctionUserState"></a>  

***
<br><br>[$updateStarGiftCraftFail](/API_docs/constructors/updateStarGiftCraftFail.html) = \[\];<a name="updateStarGiftCraftFail"></a>  
...
***
<br><br>[$updateUserTyping](/API_docs/constructors/updateUserTyping.html) = \['user_id' => [long](/API_docs/types/long.html), 'top_msg_id' => [int](/API_docs/types/int.html), 'action' => [SendMessageAction](/API_docs/types/SendMessageAction.html), \];<a name="updateUserTyping"></a>  

***
<br><br>[$updateWebBrowserException](/API_docs/constructors/updateWebBrowserException.html) = \['delete' => [Bool](/API_docs/types/Bool.html), 'open_external_browser' => [Bool](/API_docs/types/Bool.html), 'exception' => [WebDomainException](/API_docs/types/WebDomainException.html), \];<a name="updateWebBrowserException"></a>  

***
<br><br>[$updateWebBrowserSettings](/API_docs/constructors/updateWebBrowserSettings.html) = \['open_external_browser' => [Bool](/API_docs/types/Bool.html), 'display_close_button' => [Bool](/API_docs/types/Bool.html), \];<a name="updateWebBrowserSettings"></a>  
...
***
<br><br>[$userFull](/API_docs/constructors/userFull.html) = \['blocked' => [Bool](/API_docs/types/Bool.html), 'phone_calls_available' => [Bool](/API_docs/types/Bool.html), 'phone_calls_private' => [Bool](/API_docs/types/Bool.html), 'can_pin_message' => [Bool](/API_docs/types/Bool.html), 'has_scheduled' => [Bool](/API_docs/types/Bool.html), 'video_calls_available' => [Bool](/API_docs/types/Bool.html), 'voice_messages_forbidden' => [Bool](/API_docs/types/Bool.html), 'translations_disabled' => [Bool](/API_docs/types/Bool.html), 'stories_pinned_available' => [Bool](/API_docs/types/Bool.html), 'blocked_my_stories_from' => [Bool](/API_docs/types/Bool.html), 'wallpaper_overridden' => [Bool](/API_docs/types/Bool.html), 'contact_require_premium' => [Bool](/API_docs/types/Bool.html), 'read_dates_private' => [Bool](/API_docs/types/Bool.html), 'sponsored_enabled' => [Bool](/API_docs/types/Bool.html), 'can_view_revenue' => [Bool](/API_docs/types/Bool.html), 'bot_can_manage_emoji_status' => [Bool](/API_docs/types/Bool.html), 'display_gifts_button' => [Bool](/API_docs/types/Bool.html), 'noforwards_my_enabled' => [Bool](/API_docs/types/Bool.html), 'noforwards_peer_enabled' => [Bool](/API_docs/types/Bool.html), 'unofficial_security_risk' => [Bool](/API_docs/types/Bool.html), 'id' => [long](/API_docs/types/long.html), 'about' => [string](/API_docs/types/string.html), 'settings' => [PeerSettings](/API_docs/types/PeerSettings.html), 'personal_photo' => [Photo](/API_docs/types/Photo.html), 'profile_photo' => [Photo](/API_docs/types/Photo.html), 'fallback_photo' => [Photo](/API_docs/types/Photo.html), 'notify_settings' => [PeerNotifySettings](/API_docs/types/PeerNotifySettings.html), 'bot_info' => [BotInfo](/API_docs/types/BotInfo.html), 'pinned_msg_id' => [int](/API_docs/types/int.html), 'common_chats_count' => [int](/API_docs/types/int.html), 'folder_id' => [int](/API_docs/types/int.html), 'ttl_period' => [int](/API_docs/types/int.html), 'theme' => [ChatTheme](/API_docs/types/ChatTheme.html), 'private_forward_name' => [string](/API_docs/types/string.html), 'bot_group_admin_rights' => [ChatAdminRights](/API_docs/types/ChatAdminRights.html), 'bot_broadcast_admin_rights' => [ChatAdminRights](/API_docs/types/ChatAdminRights.html), 'wallpaper' => [WallPaper](/API_docs/types/WallPaper.html), 'stories' => [PeerStories](/API_docs/types/PeerStories.html), 'business_work_hours' => [BusinessWorkHours](/API_docs/types/BusinessWorkHours.html), 'business_location' => [BusinessLocation](/API_docs/types/BusinessLocation.html), 'business_greeting_message' => [BusinessGreetingMessage](/API_docs/types/BusinessGreetingMessage.html), 'business_away_message' => [BusinessAwayMessage](/API_docs/types/BusinessAwayMessage.html), 'business_intro' => [BusinessIntro](/API_docs/types/BusinessIntro.html), 'birthday' => [Birthday](/API_docs/types/Birthday.html), 'personal_channel_id' => [long](/API_docs/types/long.html), 'personal_channel_message' => [int](/API_docs/types/int.html), 'stargifts_count' => [int](/API_docs/types/int.html), 'starref_program' => [StarRefProgram](/API_docs/types/StarRefProgram.html), 'bot_verification' => [BotVerification](/API_docs/types/BotVerification.html), 'send_paid_messages_stars' => [long](/API_docs/types/long.html), 'disallowed_gifts' => [DisallowedGiftsSettings](/API_docs/types/DisallowedGiftsSettings.html), 'stars_rating' => [StarsRating](/API_docs/types/StarsRating.html), 'stars_my_pending_rating' => [StarsRating](/API_docs/types/StarsRating.html), 'stars_my_pending_rating_date' => [int](/API_docs/types/int.html), 'main_tab' => [ProfileTab](/API_docs/types/ProfileTab.html), 'saved_music' => [Document](/API_docs/types/Document.html), 'note' => [TextWithEntities](/API_docs/types/TextWithEntities.html), 'bot_manager_id' => [long](/API_docs/types/long.html), \];<a name="userFull"></a>  
...
***
<br><br>[$users.savedMusic](/API_docs/constructors/users.savedMusic.html) = \['count' => [int](/API_docs/types/int.html), 'documents' => \[[Document](/API_docs/types/Document.html)\], \];<a name="users.savedMusic"></a>  

***
<br><br>[$users.savedMusicNotModified](/API_docs/constructors/users.savedMusicNotModified.html) = \['count' => [int](/API_docs/types/int.html), \];<a name="users.savedMusicNotModified"></a>  
...
***
<br><br>[$webDomainException](/API_docs/constructors/webDomainException.html) = \['domain' => [string](/API_docs/types/string.html), 'url' => [string](/API_docs/types/string.html), 'title' => [string](/API_docs/types/string.html), 'favicon' => [long](/API_docs/types/long.html), \];<a name="webDomainException"></a>  
...
***
<br><br>[$webPageAttributeAiComposeTone](/API_docs/constructors/webPageAttributeAiComposeTone.html) = \['emoji_id' => [long](/API_docs/types/long.html), \];<a name="webPageAttributeAiComposeTone"></a>  

***
<br><br>[$webPageAttributeStarGiftAuction](/API_docs/constructors/webPageAttributeStarGiftAuction.html) = \['gift' => [StarGift](/API_docs/types/StarGift.html), 'end_date' => [int](/API_docs/types/int.html), \];<a name="webPageAttributeStarGiftAuction"></a>  

***
<br><br>[$webPageAttributeStarGiftCollection](/API_docs/constructors/webPageAttributeStarGiftCollection.html) = \['icons' => \[[Document](/API_docs/types/Document.html)\], \];<a name="webPageAttributeStarGiftCollection"></a>  
...
***
<br><br>[$webViewResultUrl](/API_docs/constructors/webViewResultUrl.html) = \['fullsize' => [Bool](/API_docs/types/Bool.html), 'fullscreen' => [Bool](/API_docs/types/Bool.html), 'same_origin' => [Bool](/API_docs/types/Bool.html), 'query_id' => [long](/API_docs/types/long.html), 'url' => [string](/API_docs/types/string.html), \];<a name="webViewResultUrl"></a>  
