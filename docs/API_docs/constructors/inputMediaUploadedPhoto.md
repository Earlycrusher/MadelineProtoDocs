...
```
$inputMediaUploadedPhoto = ['_' => 'inputMediaUploadedPhoto', 'spoiler' => Bool, 'live_photo' => Bool, 'file' => InputFile, 'stickers' => [InputDocument, InputDocument], 'ttl_seconds' => int, 'video' => InputDocument];
```  
